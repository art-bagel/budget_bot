...
- [ ] В [Operations.tsx](/Users/aleksandrkostenko/Desktop/Dev/budget_bot/frontend/src/pages/Operations.tsx) добавить отдельную вкладку `Инвестиции`
- [ ] Показывать там:
  - [ ] переводы в инвестиции
  - [ ] переводы из инвестиций
  - [ ] открытие позиции
  - [ ] закрытие позиции
  - [ ] дивиденды / проценты / иные доходы
- [ ] Добавить отдельные фильтры по investment operation type
- [ ] Не смешивать инвестиционные операции с расходной аналитикой по категориям
...
- [ ] отдельная вкладка инвестиционных операций
- [ ] фильтры
- [ ] улучшенные подписи событий
