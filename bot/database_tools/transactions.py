...
class Transactions(DataBase):
    ...
    def create_recursive_transaction(self, user_id: int, id_from: int, id_to: int, amount: float, descr: str = '') -> str:
        func = f'{self.schema}.create__recursive_transaction'
        return self.call_function(func, user_id, id_from, id_to, amount, descr)[0]
