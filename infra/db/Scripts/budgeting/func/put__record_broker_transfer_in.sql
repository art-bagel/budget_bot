CREATE OR REPLACE FUNCTION budgeting.put__record_broker_transfer_in(
    _user_id               bigint,
    _owner_type            text,
...
BEGIN
    ...
    VALUES (_user_id, _owner_type, _owner_user_id, _owner_family_id, 'account_transfer', _comment)
