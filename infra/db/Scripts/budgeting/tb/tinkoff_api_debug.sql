...
-- Сырые дампы ответов Tinkoff API для разбора расхождений синхронизации.
-- Перенесено из миграции 019_tinkoff_api_debug_dump: таблицы создавались
-- только там, и свежая установка из tb/ оставалась без них.
